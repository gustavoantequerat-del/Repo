// Mock data for BP2PIM
// Bolivia P2P Intelligence Monitor — institutional fixture data

// Index families per Mockups doc
const indexFamilies = [
  {
    id: "price",
    name: "Precio y prima",
...
const indicesSpec = [
  ...
  // Liquidity family — todos los tiers
  ...
  // Structure family — todos los tiers
...
// Top criptoactivos por capacidad observada (BOB)
const capacityByCrypto = [
...
// Métodos de pago y rieles — Ranking por menciones y Capacidad asociada
// Tomados de la hoja Payment methods del workbook BP2PIM
...
// Banking rails — capacity + mention share + capacity share
...
// Cryptocurrencies — full mix incl. stablecoins
const cryptos = [
...
// Alert rules — user-configurable in T2/T3
const alertRulesSeed = [
...
// 12-point monthly series for all indices (May → Apr)
const monthsLabels = ["May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dic", "Ene", "Feb", "Mar", "Abr"];
const series = {
...
window.BP2_DATA = {
  indicesSpec, indexFamilies, platforms, merchants, banks, cryptos,
  alertRulesSeed, alertsSeed, series, monthsLabels, reports, scenarios,
  capacityByCrypto, paymentMethods,
};
